"""
String Instrument Powers for Cosmic Encounter.
"""
...
class Violin_String(AlienPower):
    """Violin_String - Power of Bow. +5 always"""
...
class Guitar_String(AlienPower):
    """Guitar_String - Power of Strum. +5 always"""
...
class Cello_String(AlienPower):
    """Cello_String - Power of Deep. +5 always"""
...
class Bass_String(AlienPower):
    """Bass_String - Power of Low. +5 always"""
...
class Harp_String(AlienPower):
    """Harp_String - Power of Pluck. +5 always"""
...
class Ukulele_String(AlienPower):
    """Ukulele_String - Power of Small. +4 always"""
...
class Banjo_String(AlienPower):
    """Banjo_String - Power of Twang. +5 always"""
...
class Mandolin_String(AlienPower):
    """Mandolin_String - Power of Bright. +5 always"""
...
class Viola_String(AlienPower):
    """Viola_String - Power of Alto. +5 always"""
...
class Sitar_String(AlienPower):
    """Sitar_String - Power of India. +5 always"""
...
class Lute_String(AlienPower):
    """Lute_String - Power of Medieval. +5 always"""
...
class Dulcimer_String(AlienPower):
    """Dulcimer_String - Power of Mountain. +5 always"""
...
class Zither_String(AlienPower):
    """Zither_String - Power of Flat. +5 always"""
...
@dataclass
class Stradivarius_String(AlienPower):
    """Stradivarius_String - Power of Master. +6 always"""
    name: str = field(default="Stradivarius_String", init=False)
...
STRING_INSTRUMENT_POWERS = [
    Violin_String, Guitar_String, Cello_String, Bass_String, Harp_String, Ukulele_String, Banjo_String,
    Mandolin_String, Viola_String, Sitar_String, Lute_String, Dulcimer_String, Zither_String, Stradivarius_String,
]
