"""
Terrain Type Powers for Cosmic Encounter.
"""
...
@dataclass
class Grassland(AlienPower):
    """Grassland - Power of Plains. +3 always."""
    name: str = field(default="Grassland", init=False)
...
class Wetland(AlienPower):
    """Wetland - Power of Swamps. +3 on defense."""
...
class Tundra(AlienPower):
    """Tundra - Power of Cold. +3 on defense."""
...
class Savanna(AlienPower):
    """Savanna - Power of Open. +3 always."""
...
class Rainforest(AlienPower):
    """Rainforest - Power of Life. +4 always."""
...
class Steppe(AlienPower):
    """Steppe - Power of Flat. +3 on offense."""
...
class Prairie(AlienPower):
    """Prairie - Power of Grass. +2 always."""
...
class Plateau(AlienPower):
    """Plateau - Power of High. +4 on defense."""
...
class Canyon(AlienPower):
    """Canyon - Power of Depth. +3 on defense."""
...
class Marsh(AlienPower):
    """Marsh - Power of Wet. +3 on defense."""
...
class Glacier(AlienPower):
    """Glacier - Power of Ice. +4 on defense."""
...
class Delta(AlienPower):
    """Delta - Power of Rivers. +3 always."""
...
class Fjord(AlienPower):
    """Fjord - Power of Carved. +4 always."""
...
TERRAIN_TYPE_POWERS = [
    Grassland, Wetland, Tundra, Savanna, Rainforest,
    Taiga, Steppe, Prairie, Plateau, Canyon,
    Valley, Marsh, Dune, Glacier, Oasis,
    Cliff, Delta, Fjord,
]

for power_class in TERRAIN_TYPE_POWERS:
    try:
