"""
Maori Mythology Powers - New Zealand Maori folklore themed aliens.
"""
...
class Ranginui(AlienPower):
    """Ranginui - Sky father. +4 on defense."""
...
@dataclass
class Hine_nui(AlienPower):
    """Hine_nui - Death goddess. Retrieve 3 ships."""
    name: str = field(default="Hine_nui", init=False)
...
@dataclass
class Maui_Maori(AlienPower):
    """Maui_Maori - Trickster hero. Win ties."""
    name: str = field(default="Maui_Maori", init=False)
...
class Tangaroa(AlienPower):
    """Tangaroa - Sea god. See opponent card."""
...
class Papatuanuku(AlienPower):
    """Papatuanuku - Earth mother. +2 per home colony."""
...
@dataclass
class Tawhaki(AlienPower):
    """Tawhaki - Sky hero. +3 first encounter."""
    name: str = field(default="Tawhaki", init=False)
...
class Tawhirimatea(AlienPower):
    """Tawhirimatea - Storm god. +3 defending home."""
...
class Ruaumoko(AlienPower):
    """Ruaumoko - Earthquake god. -2 to opponent."""
...
@dataclass
class Hine_titama(AlienPower):
    """Hine_titama - Dawn maiden. +1 per ally."""
    name: str = field(default="Hine_titama", init=False)
...
@dataclass
class Io(AlienPower):
    """Io - Supreme being. +1 per card."""
    name: str = field(default="Io", init=False)
...
@dataclass
class Haumia(AlienPower):
    """Haumia - Wild food god. Ships go home."""
    name: str = field(default="Haumia", init=False)
...
# Register all powers
MAORI_POWERS = [
    Tane, Ranginui, Tu, Rongo, Hine_nui, Maui_Maori, Tangaroa, Papatuanuku,
    Tawhaki, Whiro, Tawhirimatea, Ruaumoko, Hine_titama, Io, Haumia,
]

for power_class in MAORI_POWERS:
    try:
