...
class Bee_Insect(AlienPower):
    """Bee_Insect - Power of Honey. +5 always"""
...
class Ant_Insect(AlienPower):
    """Ant_Insect - Power of Colony. +5 always"""
...
class Beetle_Insect(AlienPower):
    """Beetle_Insect - Power of Shell. +5 on defense"""
...
class Dragonfly_Insect(AlienPower):
    """Dragonfly_Insect - Power of Hover. +5 always"""
...
class Grasshopper_Insect(AlienPower):
    """Grasshopper_Insect - Power of Leap. +5 on offense"""
...
class Moth_Insect(AlienPower):
    """Moth_Insect - Power of Night. +5 always"""
...
class Wasp_Insect(AlienPower):
    """Wasp_Insect - Power of Sting. +5 on offense"""
...
class Mantis_Insect(AlienPower):
    """Mantis_Insect - Power of Pray. +5 always"""
...
class Cicada_Insect(AlienPower):
    """Cicada_Insect - Power of Loud. +4 always"""
...
@dataclass
class Termite_Insect(AlienPower):
    """Termite_Insect - Power of Build. +5 always"""
    name: str = field(default="Termite_Insect", init=False)
    description: str = field(default="+5 always", init=False)
    timing: PowerTiming = field(default=PowerTiming.RESOLUTION, init=False)
    power_type: PowerType = field(default=PowerType.MANDATORY, init=False)
    category: PowerCategory = field(default=PowerCategory.YELLOW, init=False)
...
@dataclass
class Scarab_Insect(AlienPower):
    """Scarab_Insect - Power of Sacred. +6 always"""
    name: str = field(default="Scarab_Insect", init=False)
...
INSECT_TYPE_NEW_POWERS = [
    Bee_Insect, Ant_Insect, Butterfly_Insect, Beetle_Insect, Dragonfly_Insect, Grasshopper_Insect, Ladybug_Insect,
    Moth_Insect, Wasp_Insect, Firefly_Insect, Mantis_Insect, Cicada_Insect, Termite_Insect, Scarab_Insect,
]

for power_class in INSECT_TYPE_NEW_POWERS:
    try:
