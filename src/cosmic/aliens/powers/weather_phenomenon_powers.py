"""
Weather Phenomenon Powers - Weather themed aliens.
"""
...
class Thunderstorm_Weather(AlienPower):
    """Thunderstorm_Weather - Electric fury."""
...
class Hurricane_Weather(AlienPower):
    """Hurricane_Weather - Rotating power."""
...
class Tornado_Weather(AlienPower):
    """Tornado_Weather - Twisting funnel."""
...
@dataclass
class Hailstorm_Weather(AlienPower):
    """Hailstorm_Weather - Ice pellets."""
    name: str = field(default="Hailstorm_Weather", init=False)
...
@dataclass
class Sleet_Weather(AlienPower):
    """Sleet_Weather - Icy rain."""
    name: str = field(default="Sleet_Weather", init=False)
...
class Lightning_Weather(AlienPower):
    """Lightning_Weather - Electric strike."""
...
@dataclass
class Breeze_Weather(AlienPower):
    """Breeze_Weather - Gentle wind."""
    name: str = field(default="Breeze_Weather", init=False)
...
WEATHER_PHENOMENON_POWERS = [
    Thunderstorm_Weather, Hurricane_Weather, Blizzard_Weather, Tornado_Weather,
    Rainbow_Weather, Fog_Weather, Hailstorm_Weather, Monsoon_Weather,
    Drought_Weather, Aurora_Weather, Sandstorm_Weather, Sunshine_Weather,
    Sleet_Weather, Lightning_Weather, Breeze_Weather
]

for power_class in WEATHER_PHENOMENON_POWERS:
    try:
